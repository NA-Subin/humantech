    ...
    <Container maxWidth="xl" sx={{ p: 5}}>
        <Box sx={{ flexGrow: 1, p:5}}>
          <Grid container spacing={2}>
            <Grid item size={4}>
                <Typography variant="subtitle2" gutterBottom>ตั้งค่า / ข้อมูลกลุ่มผู้ใช้</Typography>
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>รายการกลุ่มผู้ใช้งานในระบบ</Typography>
            </Grid>
            ...
            <Grid item size={4} marginTop={2} textAlign="right">
                <Button variant="contained">เพิ่มกลุ่มผู้ใช้</Button>
            </Grid>
          </Grid>
        </Box>
        <Item>
            <Typography variant="subtitle1" fontWeight="bold" gutterBottom>รายการกลุ่มผู้ใช้งานสำหรับ CCS</Typography>
            <Divider />
            <Box marginTop={2}>
                    ...
                    <Table aria-label="collapsible table">
                        <TableHead>
                            <TableRow sx={{ backgroundColor: theme.palette.primary.main }}>
                                <TablecellHeader>รหัสกลุ่มผู้ใช้งาน</TablecellHeader>
                                <TablecellHeader>ชื่อกลุ่มผู้ใช้งาน</TablecellHeader>
                                <TablecellHeader/>
                            </TableRow>
                        </TableHead>
                        <TableBody>
