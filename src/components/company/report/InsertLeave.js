...
export default function InsertLeave() {
    ...
    return (
        <React.Fragment>
            <Button variant="contained" onClick={() => setOpen(true)} >เพิ่มเอกสารขอลางาน</Button>
            <Dialog
                open={open}
                onClose={handleClose}
                keepMounted
            ...
            >
                ...
                >
                    <Grid container spacing={2}>
                        <Grid item size={10}>
                            <Typography variant="h6" fontWeight="bold" gutterBottom>เพิ่มเอกสารขอลางาน</Typography>
                        </Grid>
